...
module.exports = function ({ webpackConfig, plugins, theme = {}, runtimePath }) {
  if (isDev()) {
    webpackConfig.module.rules[4].use[1].options.modules = {
      // 自定义生成的类名
    ...
    webpackConfig.module.rules[4].use[3].query.modifyVars = theme;
  } else {
    // include的APP_PATH中的less文件使用cssModules
    webpackConfig.module.rules[4].use[2].options.modules = true;
    webpackConfig.module.rules[4].use[4].query.modifyVars = theme;
  }
